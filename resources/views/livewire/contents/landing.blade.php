    ...
    <div class="max-w-6xl mx-auto px-4 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <div class="bg-[#FDC261]/20 border border-[#FDC261] rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition duration-300 ease-in-out transform">
                ...
                <h3 class="text-xl font-semibold text-[#3B9B3C] mb-2">DONASI UANG</h3>
                <p class="text-gray-600 text-sm pb-4">
                    Mendukung yayasan dengan donasi uang untuk membantu pengembangan program sosial kami.
                </p>
                <a href="#" class="inline-flex items-center px-4 py-2 pt text-sm font-medium text-center text-white bg-[#3B9B3C] rounded-lg hover:bg-[#2a7f2f] focus:ring-4 focus:outline-none focus:ring-[#2a7f2f]">
                    Donasi Sekarang
                    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                    </svg>
            ...
            <div class="bg-[#FDC261]/20 border border-[#FDC261] rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition duration-300 ease-in-out transform">
                ...
                <h3 class="text-xl font-semibold text-[#3B9B3C] mb-2">DONASI PAKAIAN</h3>
                <p class="text-gray-600 text-sm pb-6">
                    Menyumbangkan pakaian layak pakai untuk disalurkan kepada yang membutuhkan.
                </p>
                <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#3B9B3C] rounded-lg hover:bg-[#2a7f2f] focus:ring-4 focus:outline-none focus:ring-[#2a7f2f]">
                    Donasi Sekarang
                    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9" />
                    </svg>
            ...
            <div class="bg-[#FDC261]/20 border border-[#FDC261] rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition duration-300 ease-in-out transform">
                ...
                <h3 class="text-xl font-semibold text-[#3B9B3C] mb-2">DONASI BARANG</h3>
                <p class="text-gray-600 text-sm pb-6">
                    Menyumbangkan barang bekas yang masih layak pakai untuk disalurkan kepada yang membutuhkan.
                </p>
                <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-[#3B9B3C] rounded-lg hover:bg-[#2a7f2f] focus:ring-4 focus:outline-none focus:ring-[#2a7f2f]">
                    Donasi Sekarang
                    <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
...
<!-- Section Dokumentasi -->
<section class="bg-[#3B9B3C] text-white py-16">
    <div class="max-w-6xl mx-auto px-6">

      <!-- Judul Utama -->
      <div class="mb-12">
        <h1 class="text-3xl md:text-4xl font-bold mb-2">Dokumentasi Kegiatan</h1>
        <div class="w-24 h-1 bg-[#FDC261] rounded-full"></div>
        <p class="mt-4 text-sm md:text-base text-white/80 max-w-2xl">
          Berikut adalah beberapa dokumentasi kegiatan yang telah dilaksanakan oleh Yayasan Haadii Nurul Ikhlas dalam bentuk galeri foto dan video.
        </p>
      </div>
