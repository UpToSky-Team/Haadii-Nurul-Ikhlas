<body class="bg-gray-100 font-sans text-gray-800">
  <div class="flex-grow px-6 pb-20 pt-32 md:px-20 lg:px-32">
      ...
      <div class="">
          <!-- Judul -->
          <h1 class="mb-8 text-start text-3xl mt-4 font-bold sm:text-4xl">Layanan Donasi</h1>
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
              ...
              <div class="rounded-xl bg-white p-6 shadow">
                  ...
                  <ul class="space-y-4 text-sm">
                      <li><strong>BRI:</strong> 1134-01-000914-50-6<br /><span class="text-gray-600">a.n Yayasan
                              Haadii Nurul Ikhlas</span></li>
                      <li><strong>BSI:</strong> 1026515088<br /><span class="text-gray-600">a.n YAYASAN HAADII NURUL
                              IKHLAS</span></li>
                      <li><strong>BJB Syariah:</strong> 5370206002626<br /><span class="text-gray-600">a.n Yayasan
                              Haadii Nurul Ikhlas</span></li>
                      <li><strong>BNI:</strong> 0377150785<br /><span class="text-gray-600">a.n Faris Nur (Ketua
                              Yayasan)</span></li>
                      <li><strong>Mandiri:</strong> 133-00-1464495-9<br /><span class="text-gray-600">a.n Faris
                              Nur</span></li>
                      <li><strong>BCA:</strong> 5720465398<br /><span class="text-gray-600">a.n Yayasan HNI</span>
                      </li>
                  </ul>
              </div>
              ...
              <div class="flex flex-col items-center justify-center rounded-xl bg-white p-6 shadow">
                  ...
                  <img src="/img/qrcode.png" alt="QR Code Donasi" class="h-64 w-64 object-contain" />
