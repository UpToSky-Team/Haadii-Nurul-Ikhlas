<body class="bg-gray-50 text-gray-800 font-sans">
    ...
    <div class="flex-grow pb-20 px-6 md:px-20 lg:px-32 pt-32">
      ...
      <!-- Breadcrumb -->
      <nav class="flex px-5 py-3 border border-gray-300 rounded-lg bg-white text-black shadow-sm mb-10" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">

          <!-- Item 1: Home -->
          <li class="inline-flex items-center">
            <a href="/" class="group inline-flex items-center text-sm font-medium text-black hover:text-green-500">
              <svg class="w-3 h-3 me-2.5 text-black group-hover:text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="flex gap-4 flex-wrap mt-4">
      ...
      @endforeach
        ...
        <!-- Tombol Kembali -->
        <div class="mt-10">
          <a href="/publikasi" class="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition ease-in-out duration-300 transform hover:scale-105">
