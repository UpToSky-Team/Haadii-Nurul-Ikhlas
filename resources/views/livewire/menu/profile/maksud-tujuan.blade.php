...
<body class="bg-gray-100 text-gray-800 mt-20">
    <div class="container mx-auto px-6 py-12 max-w-4xl pt-40">
        <nav class="flex px-5 py-3 border border-green-700 rounded-lg bg-green-600 text-white" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ms-1 text-sm font-medium text-white hover:underline md:ms-2">Profile</a>
                </div>
              </li>
              ...
              <li aria-current="page">
                <div class="flex items-center">
                  ...
                  <span class="ms-1 text-sm font-medium text-white md:ms-2">Maksud dan Tujuan</span>
                </div>
              </li>
